...
| **[Container bash script](containers/nginx-cors-private/README.md)** <br/> A Bash script runnning on a schedule using serverless containers | Bash | [Serverless Framework] |
